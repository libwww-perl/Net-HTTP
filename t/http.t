...

{
    ...
    my %servers = (
        a => {
            ...
            "/chunked,chunked" =>
                "HTTP/1.1 200 OK${CRLF}Transfer-Encoding: chunked${CRLF}Transfer-Encoding: chunked${CRLF}${CRLF}0002; foo=3; bar${CRLF}He${CRLF}1${CRLF}l${CRLF}2${CRLF}lo${CRLF}0000${CRLF}Content-MD5: xxx${CRLF}${CRLF}",
            "/head" =>
...
is(
    "@{$res->{headers}}",
    "Transfer-Encoding chunked Transfer-Encoding chunked Content-MD5 xxx"
);
